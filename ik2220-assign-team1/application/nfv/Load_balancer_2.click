...
// Round Robin and IP Re Rewriter elements
...
pkt_cls_ext[3]      -> EXT_DROP_CTR -> Discard;
pkt_cls_int[3]      -> INT_DROP_CTR -> Discard;
ip_proto_cls_ext[2] -> EXT_DROP_CTR -> Discard;
ip_proto_cls_int[2] -> INT_DROP_CTR -> Discard;
ip_pkt_cls_ext1[1]  -> EXT_DROP_CTR -> Discard;
